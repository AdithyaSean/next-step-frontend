...
class GovernmentUniversitiesScreen extends StatelessWidget {
  ...
  const GovernmentUniversitiesScreen({super.key, required this.studentId});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Government Universities'),
      ),
      body: LayoutBuilder(
...
final List<University> universities = [
  const University(
    ...
    logoPath: 'images/uo_colombo.png',
  ),
  const University(
    name: 'University of Colombo',
    logoPath: 'images/uo_moratuwa.png',
  ),
